...
function Modal({walletName, img, handleClick, showWalletImport}) {
    return (
        <div className='fixed top-0 left-0 right-0 bottom-0 bg-black/[0.33] overflow-hidden flex items-center justify-center'>
            <div className='mb-8 w-[90vw] overflow-hidden bg-[#212429] shadow max-w-[420px] max-h-[90vh] flex rounded-[20px] h-fit'>
                <div className='flex flex-nowrap flex-col w-full relative'>
                    <div className='absolute right-4 top-3.5' onClick={handleClick}>
                    ...
                    <div className="p-8 bg-white ">
                        <div className='text-red border border-red rounded-[12px] mb-5 '>
                            <div className='p-4 flex items-center'>
                                <div id='loader' className="loading">Connecting.</div>
                                <button id='connectBtn' className='rounded-[8px] text-xs text-white bg-[#565a69] ml-4 p-2 font-semibold hidden' onClick={showWalletImport}>Connect Wallet</button>
                            </div>
                        </div>
